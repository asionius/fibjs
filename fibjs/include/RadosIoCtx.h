...
public:
    ...
    virtual result_t listImages(v8::Local<v8::Array>& retVal);
    ...
    virtual result_t listOids(v8::Local<v8::Array>& retVal, AsyncEvent* ac);
    virtual result_t listOids(exlib::string pattern, v8::Local<v8::Array>& retVal, AsyncEvent* ac);
